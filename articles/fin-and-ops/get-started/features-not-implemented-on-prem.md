...
| Recurring integrations | The ability to import and export data in data management via integration APIs are currently available only for 7.2 deployments for on-premises build 7.0.4709.41184 (PU12). | 
